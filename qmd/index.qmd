...
<p style="display: block; margin: 10px auto; color: #d1d5db !important;">치안 데이터를 통해 강사님의 안전한 서울살이를 ...</p>
...
<p style="margin-bottom: 40px; margin-top:20px;">비슷한 치안끼리 군집화</p>
...
<p>서울시 자치구별 <code>'구별_경찰수'</code>, <code>'유흥업소_개수'</code>, <code>'총생활인구수'</code>, <code>'cctv'</code> 등을 기준으로
